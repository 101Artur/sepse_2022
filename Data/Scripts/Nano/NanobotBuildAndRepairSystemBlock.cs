namespace SpaceEquipmentLtd.NanobotBuildAndRepairSystem
{
   ...
   public class NanobotBuildAndRepairSystemBlock : MyGameLogicComponent
   {
      ...
      public const int WELDER_RANGE_DEFAULT_IN_M = 25; //*2 = AreaSize
      ...
      public const int WELDER_OFFSET_MAX_DEFAULT_IN_M = 50;
      ...
      public const float WELDER_REQUIRED_ELECTRIC_POWER_STANDBY_DEFAULT = 100000f / 1000; //20W
      public const float WELDER_REQUIRED_ELECTRIC_POWER_WELDING_DEFAULT = 10000.0f / 1000; //2kW
      public const float WELDER_REQUIRED_ELECTRIC_POWER_GRINDING_DEFAULT = 1500f / 1000; //1.5kW
      public const float WELDER_REQUIRED_ELECTRIC_POWER_TRANSPORT_DEFAULT = 10000.0f / 1000; //10kW
