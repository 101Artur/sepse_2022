...
namespace SolarMap
{
    ...
    [MyTextSurfaceScript("SolarMap", "Solar Map")]
    public class SolarMap : SolarMapTSSBase
    {

        public SolarMap(IMyTextSurface surface, IMyCubeBlock block, Vector2 size) : base(surface, block, size)
        {
